...
HRESULT HealtyGuy::init()
{
	...
	_vDialog2.push_back("À½½ÄÀº °ð Ã¼·ÂÀÌ¶ó°í Ä£±¸!");
	_vDialog2.push_back("À½½ÄÀ» ¸ÔÀ¸·Á¸é OÅ°¸¦, ¾Æ´Ï¸é PÅ°¸¦ ´©¸£°Ô");
	_vDialog2.push_back("Ã¼·ÂÀÌ Áõ°¡ÇÏ´Â°Ô ´À²¸ÁöÁö ¾Ê´Â°¡. ÇÏÇÏÇÏÇÏ!");

	//ºÐ±â¼±ÅÃ
	//_vDialog2.push_back("À½½ÄÀ» ¸Ô°í ½ÍÀ¸¸é ¾ðÁ¦µç ¸»À» °Éµµ·Ï ÇÏ°Ô!");
...
void HealtyGuy::update()
{
	...
	//{
	//	//ÀÎµ¦½º°ªÀ¸·Î ´ÙÀÌ¾ó·Î±× º¤ÅÍ¿¡ ÀÖ´Â °ªÀ» »©³½´Ù
	//
