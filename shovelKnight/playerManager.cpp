...
HRESULT playerManager::init()
{
	...
	IMAGEMANAGER->addFrameImage("shovelDamaged", ".//image//shovelKnight//shovelKnightDamaged.bmp", 40, 76, 4, 2, true, RGB(255, 0, 255));
	...
	IMAGEMANAGER->addFrameImage("shovelJump", ".//image//shovelKnight//shovelKnightJump.bmp", 68, 68, 4, 2, true, RGB(255, 0, 255));
